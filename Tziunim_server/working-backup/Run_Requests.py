...
def main(profs_list,psycho):
    #psycho=['660','630','600','150']
    technion_results=Technion_Request(profs_list, psycho)
    #print(technion_results.bagrot_score)
...
def parse_modle_1_request(user_input:dict):
    ...
    for key in user_input:
        proof_list.append(Profs.Prof(key, user_input[key][0], user_input[key][1]))
    return proof_list

# print(parse_modle_1_request({'math':[5,90]}))

# if __name__ == "__main__":
#     main(listp, ('660', '630', '600', '150'))
