...
class Technion_Request:
    ...
    sifi_cabla = {'אדריכלות נוף':'80', 'ארכיטקטורה':'80', 'ביוכימיה מולקולרית':'83', 'ביולוגיה (עדיפות שנייה 90)':'83',
                    'הנדסת אווירונוטיקה וחלל':'84', 'הנדסה אזרחית':'85', 'הנדסת ביוטכנולוגיה ומזון':'84', 'הנדסה ביוכימית':'84',
                    'הנדסה ביו-רפואית':'87', 'הנדסה ביו-רפואית ופיזיקה':'88', 'הנדסת הסביבה':'83', 'הנדסת חומרים':'85',
                'הנדסת חומרים וביולוגיה':'86', 'הנדסת חומרים וכימיה':'86', 'הנדסת חומרים ופיזיקה':'86', 'הנדסת חשמל*':'88.3',
                'הנדסת חשמל ופיזיקה':'91', 'הנדסה כימית':'83', 'הנדסת מיפוי וגיאו-אינפורמציה':'83', 'הנדסת מכונות':'85',
                'הנדסת מערכות מידע*':'89', 'הנדסת נתונים ומידע':'88.5', 'הנדסת תעשייה וניהול*':'83.5','חינוך למדע וטכנולוגיה*':'83',
                'כימיה':'83', 'מדעי המחשב*':'89', 'מדעי המחשב ומתמטיקה*':'90', 'מדעי המחשב ופיזיקה':'90', 'מתמטיקה*':'84',
                'מתמטיקה עם מדעי המחשב*':'84', 'מתמטיקה עם סטטיסטיקה*':'84', 'מתמטיקה-פיזיקה*':'86', 'פיזיקה':'84', 'רפואה':'93-94',
    ...
    def parse_subjects(self):
        ...
        payload += 'psychometry=' + self.psycho_score[0] + '&'
    ...
    def get_overall_score(self):
        ...
        # self.scheme_score = str(sechem_regex[2])
        # print('The Scheme score is: ' + self.scheme_score)
        pass
