...
class Beer_Sheva_Request:
    ...
    sifi_cabla = {
        'עבודה סוציאלית​': ['500', '500', 'and'], '​לימודי המזרח התיכון': ['​450', '​450', '​or'],
        'ניהול​': ['520', '520', 'or​'], 'ניהול מלונאות ותיירות​': ['500', '500', 'or'],
        'מדעי ההתנהגות ​חד מחלקתי': ['550', '550', 'or​'],
        'מדעי ההתנהגות דו מחלקתי': ['500', '500', ''], 'פסיכולוגיה ​': ['550', '550', 'or​'],
        'סוציולוגיה אנתרופולוגיה​': ['520', '520', 'or​'],
        'לימודים רב תחומיים בחטיבות ממדעי הרוח​': ['400​', '400​', 'or​'],
        'לימודים רב תחומיים בחטיבות ממדעי החברה​': ['500', '500', 'or​'],
        'לימודים רב תחומיים בחטיבות ממדעי הרוח והחברה​​': ['450', '450', 'or'],
        'ניהול​ חד מחלקתי': ['600', '600', 'or​'], 'ניהול דו מחלקתי​': ['620', '620', 'or​'],
        'ניהול מערכות מידע​': ['630', '630', 'or​'], 'ניהול מלונאות ותיירות​': ['520', '520', 'or​'],
        'קרא ומזרח הקדום​': ['400​', '430​', 'or​'], 'ארכיאולוגיה': ['400​', '430​', 'or​'],
        'ספרות עברית​': ['450​', '450​', 'or​'], 'לשון עברית​': ['450​', '450​', 'or​'],
        'היסטוריה של עם ישראל​': ['450​', '450​', 'or​'], 'היסטוריה כללית ​': ['450​', '450​', 'or​'],
        'פילוסופיה​': ['500​', '500', 'or​'], 'לימודי מדינת ישראל​': ['450​', '450​', 'or​'],
        'מחשבת ישראל​': ['450​', '450​', 'or​'], 'לימודים רב תחומיים -  רוח​': ['450​', '450​', 'or​'],
        'לימודים רב תחומיים -  רוח וחברה​': ['530​', '530', 'or​'],
        'לימודים רב תחומיים - חברה​': ['550​', '550​', 'or​'], 'ספרויות זרות ובלשנות​': ['​', '550​', '​'],
        'אמנויות​': ['450​', '450​', 'or​'], 'לימודי המזרח התיכון​': ['500​', '500', 'or​'],
        'פוליטיקה וממשל​': ['560', '560', 'or​'], 'חינוך​': ['500​', '550​', 'and​'],
        'גיאוגרפיה ופיתוח סביבתי​': ['550', '500​', 'and​​'], 'לימודי אפריקה - דו מחלקתי​': ['​', '​', '​'],
        'מדעי ההתנהגות​': ['650', '650', 'and​​'], '*פסיכולוגיה': ['650', '650', 'and​​'],
        'פסיכולוגיה עם ניהול​': ['690', '690', 'or​​'], 'פסיכוביולוגיה': ['680', '​680', '​and'],
        '*סוציולוגיה אנתרופולוגיה': ['560', '560', 'or'], 'סוציולוגיה אנתרופולוגיה עם ניהול': ['620', '620', 'or'],
        'כלכלה במסלול דו מחלקתי​': ['630', '630', ''], 'עבודה סוציאלית​': ['645', '550​', 'and​​'],
        'עבודה סוציאלית במגמת לימודי נוער': ['600', '550', ''], '​תקשורת': ['​550', '​550', '​or'],
        'רפואה​': ['735', '​680', 'and​'], 'פיזיותרפיה​': ['645', '645', 'and​'], 'סיעוד​': ['​', '550', '​'],
        'מדעי המעבדה הרפואית​': ['600', '600', 'and​'], 'רפואת חרום​': ['​', '550​', '​'],
        'ניהול מערכות בריאות​': ['520', '520', 'or​'], 'רוקחות​': ['680', '​600', '​and'],
    ...
    def get_accepted_majors(self):
        def accept_major(major, sechem_bar, multi_pscho_bar, sign):
            print(type(sign))
            print(sign)
            print(sign == "and" or sign == "or")
            if sign == 'and':
                if sechem_bar <= self.scheme_score and multi_pscho_bar <= self.psycho_score[0]:
                    accepted.append(major)
            elif sign == 'or':
                if sechem_bar <= self.scheme_score or multi_pscho_bar <= self.psycho_score[0]:
                    accepted.append(major)
            else: # one of them is empty
                if sechem_bar == '' and multi_pscho_bar <= self.psycho_score[0]:
                    accepted.append(major)
                elif multi_pscho_bar == '' and sechem_bar <= self.scheme_score:
                    accepted.append(major)

        accepted = []
        for major in self.sifi_cabla.keys():
            value = self.sifi_cabla[major]
            accept_major(major, value[0], value[1], value[2])
    ...
    def print_results(self):
        ...
        print('The accpeted major for normal shechem are:' + str(self.accepted_majors))
